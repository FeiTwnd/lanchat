...
2. 主源码：48 个 Java 文件、11294 行（含规范中文注释），按八个包分层组织，覆盖公共模型、持久化、业务、服务器、客户端网络与 Swing 界面。
...
| 47 | com/chat/client/ui/GroupChatPanel.java | 99 | 群聊面板，接收群聊消息与系统通知 |
| 48 | com/chat/client/ui/FileTransferUI.java | 392 | 文件传输界面，进度条与传输日志 |
| — | 合计 | 11294 | 48 个主源码文件 |
